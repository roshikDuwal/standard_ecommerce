   ...
   'use strict'
            ...
            $(window).on('load resize', function() {
                ...
                if ( currMenuType !== menuType ) {
                    ...
                    if ( currMenuType === 'mobile' ) {
                        ...
                        var hasChildMenu = $('#').find('li:has(ul)');
                        ...
                        var $desktopMenu = $('#').attr('id', 'mainnav').removeAttr('style');
        ...
        var responsiveMenuMega = function() {
            ...
            $(window).on('load resize', function() {
                ...
                if ( matchMedia( 'only screen and (max-width: 7991====--px)' ).matches ) {
                    currMenuType = 'mobile';
                }
                ...
                $( function() {
                    $( "#slider-range" ).slider({
                      ...
                      slide: function( event, ui ) {
                        $( "#amount" ).val( ui.values[ 0 ] + "NRP" + " - " + ui.values[ 1 ] + "NRP" );
                      }
                    });
                       $( "#amount" ).val( "NRP" + $( "#slider-range" ).slider( "values", 0 )  + " - " +  "NRP" + $( "#slider-range" ).slider( "values", 1 )  );
                });
            }
        }; // Filter Price
